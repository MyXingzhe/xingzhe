...
if("FALSE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/bbb/projects/xingzhe/src/arm)
  set(arm_DEVEL_PREFIX /home/bbb/projects/xingzhe/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/bbb/projects/xingzhe/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bbb/projects/xingzhe/install/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
