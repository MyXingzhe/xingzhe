...
if("TRUE" STREQUAL "TRUE")
  set(eye_SOURCE_PREFIX /home/bbb/projects/src/eye)
  set(eye_DEVEL_PREFIX /home/bbb/projects/src/eye/devel)
  set(eye_INSTALL_PREFIX "")
  set(eye_PREFIX ${eye_DEVEL_PREFIX})
else()
  set(eye_SOURCE_PREFIX "")
  set(eye_DEVEL_PREFIX "")
  set(eye_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/bbb/projects/src/eye/include " STREQUAL " ")
  set(eye_INCLUDE_DIRS "")
  set(_include_dirs "/home/bbb/projects/src/eye/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bbb/projects/src/eye/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bbb/projects/src/eye/devel/lib;/opt/ros/kinetic/lib)
