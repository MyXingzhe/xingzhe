...
if("TRUE" STREQUAL "TRUE")
  ...
  set(eye_DEVEL_PREFIX /home/ubuntu/projects/xingzhe/src/devel)
...
if(NOT "/home/ubuntu/projects/xingzhe/src/eye/include " STREQUAL " ")
  set(eye_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/projects/xingzhe/src/eye/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/projects/xingzhe/src/eye/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
