...
if("TRUE" STREQUAL "TRUE")
  set(light_SOURCE_PREFIX /home/ubuntu/projects/xingzhe/src/light)
  set(light_DEVEL_PREFIX /home/ubuntu/projects/xingzhe/src/devel)
  set(light_INSTALL_PREFIX "")
  set(light_PREFIX ${light_DEVEL_PREFIX})
else()
  set(light_SOURCE_PREFIX "")
  set(light_DEVEL_PREFIX "")
  set(light_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/ubuntu/projects/xingzhe/src/light/include " STREQUAL " ")
  set(light_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/projects/xingzhe/src/light/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'light' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'light' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/projects/xingzhe/src/light/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
