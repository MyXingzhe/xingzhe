...
if("FALSE" STREQUAL "TRUE")
  ...
  set(arm_DEVEL_PREFIX /home/ubuntu/projects/xingzhe/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/ubuntu/projects/xingzhe/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/projects/xingzhe/install/${idir}'.  Ask the maintainer 'bbb <2676902@qq.com>' to fix it.")
    endif()
