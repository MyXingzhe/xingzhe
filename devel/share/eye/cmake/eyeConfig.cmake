...
if("TRUE" STREQUAL "TRUE")
  set(eye_SOURCE_PREFIX /home/bbb/projects/xingzhe/src/eye)
  set(eye_DEVEL_PREFIX /home/bbb/projects/xingzhe/devel)
  set(eye_INSTALL_PREFIX "")
  set(eye_PREFIX ${eye_DEVEL_PREFIX})
else()
  set(eye_SOURCE_PREFIX "")
  set(eye_DEVEL_PREFIX "")
  set(eye_INSTALL_PREFIX /home/bbb/projects/xingzhe/install)
...
if(NOT "/home/bbb/projects/xingzhe/src/eye/include " STREQUAL " ")
  set(eye_INCLUDE_DIRS "")
  set(_include_dirs "/home/bbb/projects/xingzhe/src/eye/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eye' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bbb/projects/xingzhe/src/eye/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
