...
if("TRUE" STREQUAL "TRUE")
  set(ear_SOURCE_PREFIX /home/bbb/projects/xingzhe/src/ear)
  set(ear_DEVEL_PREFIX /home/bbb/projects/xingzhe/devel)
  set(ear_INSTALL_PREFIX "")
  set(ear_PREFIX ${ear_DEVEL_PREFIX})
else()
  set(ear_SOURCE_PREFIX "")
  set(ear_DEVEL_PREFIX "")
  set(ear_INSTALL_PREFIX /home/bbb/projects/xingzhe/install)
...
if(NOT "/home/bbb/projects/xingzhe/src/ear/include " STREQUAL " ")
  set(ear_INCLUDE_DIRS "")
  set(_include_dirs "/home/bbb/projects/xingzhe/src/ear/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ear' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ear' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bbb/projects/xingzhe/src/ear/${idir}'.  Ask the maintainer 'bbb <bbb@todo.todo>' to fix it.")
    endif()
